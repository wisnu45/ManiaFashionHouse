...
<div class="row">
    <div class="col-12">
        <div class="card-box table-responsive">
            ...
            <div class="py-3 pl-3">
                <a class="btn btn-success waves-effect waves-light " href="{{ route('subscription.email.sent.all') }}">Sent Email to all users </a>
            </div>
            ...
            <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    @foreach ($subs as $sub)
                        <tr>
                            <td>{{ $sub->email }}</td>
                            <td><a class="btn btn-custom waves-effect waves-light btn-sm" href="{{ route('sub.email',$sub->id) }}">Send email</a></td>
                            <td><a class="btn btn-danger waves-effect waves-light btn-sm" href="{{ route('subscription.delete',$sub->id) }}">Delete</a></td>
