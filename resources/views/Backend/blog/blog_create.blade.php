...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <ol class="breadcrumb float-right">
                ...
                <li class="breadcrumb-item"><a href="{{ route('blog.create') }}">Create Blog</a></li>
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card-box">
                <h4 class="m-t-0 header-title"><b>Create Blog</b></h4>
                <form id="default-wizard" action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data" >
                    @csrf
                    <fieldset title="1">
                        ...
                        <div class="row m-t-20">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="author_name" class="form-control"  name='author_name' placeholder='Author Name'>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="tags-default">
                                        <input type="text" value="" name='tag' data-role="tagsinput" placeholder="add tags"/>
                                    </div>
                                </div>
                                 <div class="form-group">
